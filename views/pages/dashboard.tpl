                            ...
                            <div class="notification-item {if $notification.priority == 'urgent'}priority-urgent{elseif $notification.priority == 'high'}priority-high{else}priority-medium{/if}"
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="notification-actions">
                                        <button class="btn btn-sm btn-outline-primary me-1" data-action="view-appointment"
                                            data-appointment-id="{$notification.appointment_id}">
                                            <i class="bi bi-eye"></i>
                                        </button>
                                        <button class="btn btn-sm btn-outline-secondary" data-action="dismiss-notification">
                                            <i class="bi bi-x"></i>
                                        </button>
                                    </div>
                                </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        <button type="button" class="btn btn-outline-secondary w-100"
                            id="clearAppointmentSearch">Clear</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="card h-100">
                <div class="card-header bg-info bg-opacity-10 d-flex justify-content-between align-items-center">
                    ...
                    <button class="btn btn-sm btn-outline-info" data-action="refresh-activity">
                    ...
                    <div class="activity-feed" id="activityFeed">
                        ...
                        <div class="activity-item">
                            ...
                            <div class="activity-actions">
                                <button class="btn btn-sm btn-outline-primary" data-action="view-appointment"
                                    data-appointment-id="{$activity.appointment_id}">
                                    <i class="bi bi-eye"></i>
                                </button>
                            </div>
                        </div>
