                    ...
                    <div class="col-md-2 text-center">
                        <div class="patient-profile-avatar mx-auto mb-3 mb-md-0">
                            <div class="avatar-placeholder avatar-placeholder-large">
                                <span id="avatarInitial">{if $patient}{$patient.name_initial}{else}?{/if}</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <h3 class="mb-1" id="profileName">
                            {if $patient}
                                {$patient.name} <span
                                    class="badge {if $patient.status == 'active'}bg-success{else}bg-secondary{/if} fs-6 align-middle">{$patient.status_formatted}</span>
                            {else}
                                Loading... <span class="badge bg-secondary fs-6 align-middle">-</span>
                            {/if}
                        </h3>
                        <p class="text-muted mb-2" id="profileDetails">
                            {if $patient}
                                {$patient.breed} • {$patient.gender_formatted} • {if $patient.age}{$patient.age}
                                    year{if $patient.age != 1}s{/if} old{else}Age unknown{/if}
                                {else}
                                    Loading patient details...
                                {/if}
                            </p>
                            <p class="mb-1"><strong>Owner:</strong> <span
                                    id="profileOwner">{if $patient && $patient.owner_name}{$patient.owner_name}{else}Loading...{/if}</span>
                            </p>
                            <p class="mb-1"><strong>Phone:</strong> <span
                                    id="profilePhone">{if $patient && $patient.phone}{$patient.phone}{else}Loading...{/if}</span>
                            </p>
                            <p class="mb-0"><strong>Email:</strong> <span
                                    id="profileEmail">{if $patient && $patient.email}{$patient.email}{else}Loading...{/if}</span>
                            </p>
                        </div>
                        <div class="col-md-4">
                            <div class="d-flex flex-column h-100 justify-content-center">
                                <div class="alert alert-info mb-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <strong>Next visit:</strong> No upcoming appointments scheduled
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <strong>Allergies:</strong> <span
                                                id="profileAllergies">{if $patient && $patient.allergies}{$patient.allergies}{else}N/A{/if}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <p class="mb-3" id="infoSpecies">
                                        {if $patient}{$patient.species_formatted}{else}Loading...{/if}</p>

                                    <p class="mb-1 text-muted small">Breed</p>
                                    <p class="mb-3" id="infoBreed">{if $patient}{$patient.breed}{else}Loading...{/if}</p>

                                    <p class="mb-1 text-muted small">Date of Birth</p>
                                    <p class="mb-0" id="infoDob">
                                        {if $patient && $patient.date_of_birth}{$patient.date_of_birth}
                                            {if $patient.age}
                                                ({$patient.age} year{if $patient.age != 1}s{/if}){/if}{else}Loading...{/if}</p>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <p class="mb-1 text-muted small">Gender</p>
                                            <p class="mb-3" id="infoGender">
                                                {if $patient}{$patient.gender_formatted}
                                                    {if $patient.neutered == 'yes'} (Neutered)
                                                    {else}
                                                    (Not Neutered){/if}
                                                    {else}Loading...
                                                    {/if}</p>
                                                ...
                                                <p class="mb-3" id="infoWeight">{if $patient && $patient.weight}{$patient.weight}kg
                                                {else}Not
                                                    recorded{/if}</p>

                                                <p class="mb-1 text-muted small">Microchip ID</p>
                                                <p class="mb-0" id="infoMicrochip">
                                                    {if $patient && $patient.microchip_id}{$patient.microchip_id}{else}Not recorded{/if}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
